...
document.getElementById("start-bnt").addEventListener("click", () => {
  vessel = new Vessel(
    ...
    document.getElementById("namevessel").innerHTML
  );
  console.log(vessel);
...
document.getElementById("start-bnt").addEventListener("click", () => {
  laser = new Laser(
    document.getElementById("srclaser").src,
    document.getElementById("namelaser").innerHTML
  );
  console.log(laser);
...
function animate() {
  ...
  //   var rect = document.getElementById("game-vessel").getBoundingClientRect();
